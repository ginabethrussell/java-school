...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("Java School Exceptions")
            .description("Custom Exception Handlers Example")
            .contact(new Contact("Gina Russell",
                "http://www.lambdaschool.com",
                "gina-russell@lambdastudents.com"))
            .license("MIT")
            .licenseUrl("https://github.com/ginabethrussell/java-school/blob/master/LICENSE")
            .version("1.0.0")
            .build();
    }
}
